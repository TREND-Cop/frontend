/**
 * EmailVerificationScreen — 4-digit OTP verification after password reset.
 *
 * Flow: ForgotPasswordScreen → EmailVerificationScreen → SignInScreen
 *
 * Features:
 ...
 * - Navigates back to SignInScreen on successful verification
 *
 ...
 *    Payload: { "email": _email, "code": _code }
 * 2. On Success (200 OK):
 ...
 */
const resendCode = async (_email: string): Promise<void> => {
...
export const EmailVerificationScreen = ({
  ...
  // ── Route Params ────────────────────────────────────────────────────────
  // Email passed from ForgotPasswordScreen (stub fallback for development)
