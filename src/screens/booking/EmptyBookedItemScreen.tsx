...
// ── Figma Stacked Calendar with Empty Grid Illustration ──
const EmptyCalendarGridIllustration = ({ size = 160 }: { size?: number }) => (
  <View style={styles.illustrationContainer}>
    ...
    <View style={styles.mainCard}>
      <Svg width={56} height={56} viewBox="0 0 48 48" fill="none">
        ...
        />
        {/* Top Header Line */}
        <Path d="M6 18H42" stroke="#8A92A6" strokeWidth="2.2" />
        {/* Binder Pins */}
        ...
        {/* 6 Calendar Day Grid Slots (2 rows x 3 columns) */}
        {/* Row 1 */}
        <Rect x="12" y="23" width="5" height="4" rx="1" fill="#C0C0CC" />
        <Rect x="21.5" y="23" width="5" height="4" rx="1" fill="#C0C0CC" />
        <Rect x="31" y="23" width="5" height="4" rx="1" fill="#C0C0CC" />
        {/* Row 2 */}
        <Rect x="12" y="31" width="5" height="4" rx="1" fill="#C0C0CC" />
        <Rect x="21.5" y="31" width="5" height="4" rx="1" fill="#C0C0CC" />
        <Rect x="31" y="31" width="5" height="4" rx="1" fill="#C0C0CC" />
      </Svg>
    </View>
  </View>
);
...
interface EmptyBookedItemProps {
  title?: string;
  onGoBack?: () => void;
  onExploreLocations?: () => void;
}

export const EmptyBookedItemScreen: React.FC<EmptyBookedItemProps> = ({
  title = 'Appointments',
  onGoBack,
  onExploreLocations,
}) => {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      <View style={styles.contentContainer}>
        ...
        <EmptyCalendarGridIllustration size={160} />

        {/* ── Text Content ── */}
        <View style={styles.textContainer}>
          <Text style={styles.titleText}>No Booked item</Text>
          <Text style={styles.subtitleText}>
            Your appointments will appear here if any.
          </Text>
        </View>

        {/* ── Primary Action Button: Explore Locations ── */}
        <TouchableOpacity
          style={styles.actionButton}
          activeOpacity={0.85}
          onPress={handleExplore}
        >
          <Text style={styles.actionButtonText}>Explore Locations</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
...
export default EmptyBookedItemScreen;
